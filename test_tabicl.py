    ...
    for preprocess_type in preprocess:
        ...
        for fold, (train_idx, test_idx) in enumerate(splits): 
            ...
            if tuning:
                ...
                study.optimize(objective_cox, n_trials=50,n_jobs=-1)
                ...
                study_rsf.optimize(objective_rsf, n_trials=50,n_jobs=1,timeout=3600)
                params.update(study_rsf.best_params)
                print(f"Best parameters: {study_rsf.best_params}")
...
if __name__ == "__main__":
    ...
    for exp_idx, experiment in enumerate(res):
        ...
        for seed, result_list in experiment:
            for preprocess_type, (c_train_tabicl_vanilla, c_test_tabicl_vanilla), (c_train_tabicl_simple, c_test_tabicl_simple), (c_train_tabicl_tuned_cox, c_test_tabicl_tuned_cox), (c_train_tabicl_tuned_rsf, c_test_tabicl_tuned_rsf), (c_train_cox, c_test_cox), (c_train_rsf, c_test_rsf) in result_list:
